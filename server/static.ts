    ...
    if (!isBot(ua)) {
      try {
        ...
        const catTitles: Record<string, {t: string; d: string}> = {
          ...
          '/about-us': { t: 'About SarkariJobSeva - Trusted Government Job Portal', d: 'Learn about SarkariJobSeva.com, trusted platform for free government job alerts, admit cards, results and exam updates.' },
          '/about': { t: 'About SarkariJobSeva - Trusted Government Job Portal', d: 'Learn about SarkariJobSeva.com, trusted platform for free government job alerts, admit cards, results and exam updates.' },
